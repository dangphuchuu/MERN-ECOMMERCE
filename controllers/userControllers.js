...
const userControllers = {
    register: async (req, res) => {
        try {
            ...
            //? Create jasonWebToken to authentication
    ...
    login: async (req, res) => {
        try {
            ...
            //TODO: If login success, create access token and refresh token 
    ...
    getUser: async (req, res) => {
        try {
            const user = await Users.findById(req.user.id).select('-password') //! select('-password') mean remove row password in postman
